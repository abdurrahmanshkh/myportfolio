...
<div class="border-b-2 border-gray-400 dark:border-gray-700" id="about">
<AccordionItem class="pt-0" open>
	<span slot="header" class="text-2xl font-semibold text-gray-900 dark:text-white">About</span>
